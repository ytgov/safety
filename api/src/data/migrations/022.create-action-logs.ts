...
export async function up(knex: knex.Knex) {
    await knex.schema.createTable("action_logs", function(table) {
        ...
        table.foreign("old_action_type_code").references("action_types.code");
        table.foreign("old_sensitivity_code").references("sensitivities.code");
        table.foreign("old_status_code").references("action_statuses.code");
        table.foreign("new_actor_role_id").references("roles.id");
        table.foreign("new_action_type_code").references("action_types.code");
        table.foreign("new_sensitivity_code").references("sensitivities.code");
        table.foreign("new_status_code").references("action_statuses.code");
