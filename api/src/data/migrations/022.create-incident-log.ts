...
exports.up = async function(knex: knex.Knex, Promise: any) {
    await knex.schema.createTable("incident_log", function(table) {
        ...
        table.integer("old_incident_type").nullable();
        ...
        table.integer("new_incident_type").nullable();
        ...
        table.foreign("old_incident_type").references("incident_type.code");
        ...
        table.foreign("new_incident_type").references("incident_type.code");
