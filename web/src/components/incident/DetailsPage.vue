            ...
            <v-row class="pa-5 pt-2 pb-6">
              <v-col cols="12" md="12">
                ...
                <v-btn-toggle v-model="selectedReport.urgency_code" mandatory base-color="#eee" class="mb-4"
                  ...
                  <v-btn :readonly="!canEdit" color="yellow" value="Medium" style="width: 25%"
                    class="my-0">Medium</v-btn>
                  <v-btn :readonly="!canEdit" color="#ff4500" value="High" style="width: 25%" class="my-0">High</v-btn>
                  <v-btn :readonly="!canEdit" color="red" value="Critical" style="width: 25%"
                    class="my-0">Critical</v-btn>
                </v-btn-toggle>
