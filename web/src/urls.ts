...
export const DATA_INGESTION_URL = `${config.apiBaseUrl}/api/data-ingestion`;
export const DATA_INGESTION_SOURCE_URL = `${config.apiBaseUrl}/api/data-ingestion-source`;
