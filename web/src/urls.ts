...
export const DATA_INJESTION_URL = `${config.apiBaseUrl}/api/data-injestion`;
export const DATA_INJESTION_SOURCE_URL = `${config.apiBaseUrl}/api/data-injestion-source`;
